    ...
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
        <section>
          ...
          <p className="mt-2">
            Coletamos nome, e-mail e senha (armazenada de forma criptografada) no cadastro, além dos
            dados de brief e das ofertas que você gera na plataforma.
          </p>
        </section>
        <section>
          <h2 className="text-base font-semibold text-foreground">2. Como usamos seus dados</h2>
          <p className="mt-2">
            Usamos seus dados para autenticação, para gerar o conteúdo solicitado por você via IA, e
            para manter o histórico das suas ofertas salvo na sua conta.
          </p>
        </section>
        <section>
          <h2 className="text-base font-semibold text-foreground">3. Armazenamento</h2>
          <p className="mt-2">
            Seus dados são armazenados em infraestrutura do Supabase, com controle de acesso por
            conta (cada usuário só acessa os próprios dados).
          </p>
        </section>
        <section>
          ...
          <p className="mt-2">
            Não vendemos seus dados. O texto do seu brief é enviado a provedores de IA (como parte
            da geração de conteúdo) apenas para processar sua solicitação.
          </p>
        </section>
        <section>
          ...
          <p className="mt-2">
            ...
            e-mail de suporte da LowTicket AI.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p className="mt-2">
            Dúvidas sobre privacidade podem ser enviadas para o e-mail de suporte da LowTicket AI.
          </p>
        </section>
      </div>
    </div>
